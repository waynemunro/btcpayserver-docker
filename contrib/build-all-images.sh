...
# Build rtl
# https://raw.githubusercontent.com/Ride-The-Lightning/RTL/v0.11.1/docker/Dockerfile
DOCKERFILE="docker/Dockerfile"
# https://raw.githubusercontent.com/Ride-The-Lightning/RTL/v0.11.1/docker/Dockerfile.arm32v7
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="docker/Dockerfile.arm32v7"
# https://raw.githubusercontent.com/Ride-The-Lightning/RTL/v0.11.1/docker/Dockerfile.arm64v8
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="docker/Dockerfile.arm64v8"
echo "Building shahanafarooqui/rtl:0.11.1"
git clone https://github.com/Ride-The-Lightning/RTL rtl
cd rtl
git checkout v0.11.1
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "shahanafarooqui/rtl:0.11.1" .
cd - && cd ..
...
# Build btcpayserver
# https://raw.githubusercontent.com/btcpayserver/btcpayserver/v1.2.1/amd64.Dockerfile
DOCKERFILE="amd64.Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/btcpayserver/v1.2.1/arm32v7.Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="arm32v7.Dockerfile"
...
git checkout v1.2.1
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/btcpayserver:1.2.1$<BTCPAY_BUILD_CONFIGURATION>?" .
cd - && cd ..
...
# Build nbxplorer
# https://raw.githubusercontent.com/dgarage/nbxplorer/v2.1.58/Dockerfile.linuxamd64
DOCKERFILE="Dockerfile.linuxamd64"
# https://raw.githubusercontent.com/dgarage/nbxplorer/v2.1.58/Dockerfile.linuxarm32v7
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile.linuxarm32v7"
# https://raw.githubusercontent.com/dgarage/nbxplorer/v2.1.58/Dockerfile.linuxarm64v8
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile.linuxarm64v8"
echo "Building nicolasdorier/nbxplorer:2.1.58"
git clone https://github.com/dgarage/nbxplorer nbxplorer
cd nbxplorer
git checkout v2.1.58
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "nicolasdorier/nbxplorer:2.1.58" .
cd - && cd ..
